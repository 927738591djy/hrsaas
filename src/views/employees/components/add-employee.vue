  ...
  <el-dialog title="新增员工" :visible="showDialog">
    ...
    <el-form :model="formData" :rules="rules" label-width="120px">
      ...
      <el-form-item prop="formOfEmployment" label="聘用形式">
        <el-select v-model="formData.formOfEmployment" style="width:50%" placeholder="请选择" value="111">
      ...
      <el-form-item prop="departmentName" label="部门">
        ...
        <el-tree v-if="showTree" v-loading="loading" :data="treeList" :props="{label:'name'}" :default-expand-all="true " @node-click="selectNode" />
      </el-form-item>
